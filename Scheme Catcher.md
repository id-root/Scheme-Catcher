...
- No PIE (static addresses)[No PIE](https://cymulate.com/blog/binary-exploitation/)
...
>  
 ...
 > 
> Looking for writes to rbp-0x11c in reverse  
  >
 The movabs instruction was located at 0x401648.
...
`Index of /7ln6Z1X9EF - foothold.txt               37 bytes - 4.2.0-R1-1337-server.zip   5.2M`

#### Second Flag
`curl http://10.48.190.204/7ln6Z1X9EF/foothold.txt # THM{beacon_analysis_complete_on_to_stage2}`
...
- **readelf** - ELF structure analysis[](https://www.scribd.com/document/921452760/Reverse-Engineering-Report-Template)
     ​
